...
Omit `--anchor-sparse-enabled` for the matched dense baseline.  A keep ratio of
1.0 also takes the exact original dense attention path without gather/router
work and is the full-budget parity control.
